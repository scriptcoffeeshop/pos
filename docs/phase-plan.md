...
- 未收款訂單作廢已接入 POS 佇列與下一張單，需管理 PIN，會排除關帳/班別統計；已收款訂單留給退款流程處理。
- 正式班別/收銀機 session 已接第一版：`register_sessions` 保存開班/關班、開班現金、實點現金、預期現金、現金銷售、非現金、待收款與單數；開關班需 `POS_ADMIN_PIN`。
