...
- 櫃台效率操作：POS 工作台已有最近/常用品項快速加購、常用備註 chip、待處理/可交付/全部佇列篩選、庫存/低庫存提示、多平板訂單鎖定、收款確認、列印重印紀錄、正式開班/關班、關帳摘要與鍵盤捷徑；建立櫃台訂單後會清空購物車並重置顧客電話/備註，避免帶到下一張單。
