...
- 初始畫面：門市 POS 工作台預設進入乾淨的點餐頁，主畫面只放商品方格、快速加購、購物車品項、必要訂單摘要與建單按鈕；Cart 摘要可直接點擊修改顧客、方式與付款；顧客/履約/備註、付款、訂單佇列、列印站與班別資訊都透過快速導航列切換；`order.scriptcoffee.com.tw` 會預設進入消費者線上點餐頁。
