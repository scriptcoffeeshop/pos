...
export const posKnowledgeArticles: PosKnowledgeArticle[] = [
  ...
  },
  {
    ...
    summary: '訂單查詢會依店面流程設定整理今日訂單、到點、待收、可交付、未確認與列印失敗任務。',
    steps: [
      '後台「iCHEF 補齊」的「店面流程與外帶設定」可設定今日訂單開始/結束時間、出餐確認、到點提醒提前分鐘、預設外帶取餐時間、外帶循環模式與自動出店。',
    ...
    keywords: ['任務', '快篩', '取餐', '送達', '履約', '逾時', '出餐確認', '外帶循環', '自動出店', '預設取餐', '排程', '時段', '待收', '列印失敗'],
    target: 'queue',
  },
  {
